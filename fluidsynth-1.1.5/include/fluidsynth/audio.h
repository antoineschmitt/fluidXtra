...
// [AS may12 : a hacked hook to be able to record the sound output, as there is no new2 function for dsound
#ifdef _WIN32
typedef int (*fluid_audio_stereoshort_func_t)(void* data, int len, short* audio);
FLUIDSYNTH_API void fluid_dsound_audio_driver_setcallback(fluid_audio_driver_t* p, fluid_audio_stereoshort_func_t func, void* data);
#endif
