...
platforms. On Linux and other modern full-scale POSIX systems you have
gettext functionality already in the C library.
...
In the Windows binary distribution, both a 32-bit and 64-bit (amd64)
one is provided.

Tor Lillqvist <tml@iki.fi>, July 2008 and later
