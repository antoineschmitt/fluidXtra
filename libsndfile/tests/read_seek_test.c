...
static
void	double_test (char *filename)
{	int		k, count ;
	SNDFILE	*file ;
	SF_INFO	sfinfo ;
	double	*readdata ;
	...
	if (sfinfo.samples != 16)
	{	printf ("Expecting 16 samples in file, found %d.\n", sfinfo.samples) ;
		exit (1) ;
		} ;
