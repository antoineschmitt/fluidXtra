...
{	unsigned int subformat ;
	...
	if (subformat == SF_FORMAT_RAW_BE)
		psf->endian = SF_ENDIAN_BIG ;
	else if (subformat == SF_FORMAT_RAW_LE)
		psf->endian = SF_ENDIAN_LITTLE ;
	else if (subformat == SF_FORMAT_RAW_S8 || subformat == SF_FORMAT_RAW_U8)
		psf->endian = 0 ;
	else
		return SFE_RAW_READ_BAD_SPEC ;
	...
	{	case   8 :	if (subformat == SF_FORMAT_RAW_S8)
					...
					else if (subformat == SF_FORMAT_RAW_U8)
		...
		case  16 :	if (subformat == SF_FORMAT_RAW_BE)
		...
		case  24 :	if (subformat == SF_FORMAT_RAW_BE)
		...
		case  32 :	if (subformat == SF_FORMAT_RAW_BE)
