...
const static char msgTable1[] = { 
  ...
  "+getSettingsOptions object xtra, string setting -- Returns the list of possible default options for this setting\n"
  "+getSettingDefaultValue object xtra, string setting -- Returns the default value for this setting\n"
